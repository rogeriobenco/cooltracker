            ...
            <table border="0" class="table" cellpadding="0" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr style="background-color: #efefef">
                        <td colspan="2" style="padding: 10px; font-size: 12px">Olá, sua encomenda:</td>
                    </tr>
                    <tr style="background-color: #efefef">
                        <td colspan="2" style="padding: 10px">
                            <b><big><big>{{ $cod_rastreio }}</big></big><b>&nbsp;&nbsp;
                            <b><big>({{ $description }})</big></b></td>
                    </tr>

                    <tr style="background-color: #efefef"><td colspan="2" style="height: 20px;"></td></tr>

                    <tr style="background-color: #efefef">
                        <td colspan="2" style="padding: 10px; font-size: 12px">Recebeu uma atualização de status!!</td>
                    </tr>
                    <tr style="background-color: #efefef">
                        <td colspan="2" style="padding: 10px; font-size: 18px; font-weight: bold;">{{ $detail }}</td>
                    </tr>
